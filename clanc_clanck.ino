...
void setup() {
  ...
  dxl.torqueOn(6);
  dxl.writeControlTableItem(PROFILE_VELOCITY, 6, 300);
}
...
void loop() {
  ...
  dxl.setGoalVelocity(6, 300);
  dxl.setGoalPosition(6, 5500);
  ...
  //   DEBUG_SERIAL.print(" ");
  //   DEBUG_SERIAL.print(dxl.getPresentPosition(3));
  //   DEBUG_SERIAL.print(" ");
  //   DEBUG_SERIAL.print(dxl.getPresentPosition(4));
  //   DEBUG_SERIAL.print(" ");
  //   DEBUG_SERIAL.print(dxl.getPresentPosition(5));
  //   DEBUG_SERIAL.print(" ");
  //   DEBUG_SERIAL.print(dxl.getPresentPosition(6));
  //   break;
  // }
  delay(5000);
  dxl.setGoalVelocity(6, 300);
  dxl.setGoalPosition(6, 9000);
  delay(5000);
